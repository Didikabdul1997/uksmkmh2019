...
<head>
    ...
    <title>Data Karyawan  | *Quality Office*</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="nama" data-editable="true">Nama Karyawan</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($karyawan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['ttl']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_karyawan.php?id_karyawan=<?php echo $row['id_karyawan'];?>&nama=<?php echo $row['nama'];?>&alamat=<?php echo $row['alamat'];?>&telepon=<?php echo $row['telepon'];?>&jenis_kelamin=<?php echo $row['jenis_kelamin'];?>&ttl=<?php echo $row['ttl'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
