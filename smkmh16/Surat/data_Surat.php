...
<head>
    ...
    <title>Data Surat |*Quality Office*</title>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Surat</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_Surat.php">Tambah Surat</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_surat" data-editable="true">ID Surat</th>
                                                <th data-field="perihal" data-editable="true">Perihal</th>
                                                <th data-field="tanggal" data-editable="true">Tanggal</th>
												<th data-field="pengirim" data-editable="true">Pengirim</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($Surat as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['pengirim']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_Surat.php?id_surat=<?php echo $row['id_surat'];?>&perihal=<?php echo $row['perihal'];?>&tanggal=<?php echo $row['tanggal'];?>&pengirim=<?php echo $row['pengirim'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_Surat.php?id_surat=<?php echo $row['id_surat'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
