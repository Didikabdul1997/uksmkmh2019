...
<head>
    ...
    <title>Data Notification |*Quality Office*</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Notification</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Notification</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Notification</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_Notification.php">Tambah Notification</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_Notification" data-editable="true">ID Notification</th>
                                                <th data-field="perihal" data-editable="true">Perihal</th>
                                                <th data-field="tanggal" data-editable="true">Tanggal</th>
                                                <th data-field="penerima" data-editable="true">Penerima</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $Notification = mysqli_query($koneksi, "SELECT * from Notification");
                                                $no=1;
                                                foreach ($Notification as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['penerima']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_Notification.php?id_Notification=<?php echo $row['id_Notification'];?>&perihal=<?php echo $row['perihal'];?>&tanggal=<?php echo $row['tanggal'];?>&penerima=<?php echo $row['penerima'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_Notification.php?id_Notification=<?php echo $row['id_Notification'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
