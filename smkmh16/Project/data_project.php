...
<head>
    ...
    <title>Data Project |*Quality Office*</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Project</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Project</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Project</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_Project" data-editable="true">ID Project</th>
                                                <th data-field="name" data-editable="true">Name</th>
                                                <th data-field="information" data-editable="true">Information</th>
                                                <th data-field="from_date" data-editable="true">From Date</th>
												<th data-field="to_date" data-editable="true">To Date</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($Project as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['to_date']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_project.php?id_Project=<?php echo $row['id_Project'];?>&name=<?php echo $row['name'];?>&information=<?php echo $row['information'];?>&from_date=<?php echo $row['from_date'];?>&to_date=<?php echo $row['to_date'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_project.php?id_Project=<?php echo $row['id_Project'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
