...
<head>
    ...
    <title>Data pesan | SMK Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">pesan</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data pesan</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> pesan</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ID_pesan" data-editable="true">ID_pesan</th>
                                                <th data-field="ID_pelanggan" data-editable="true">Nama_pelanggan</th>
												<th data-field="tgl_sewa" data-editable="true">tgl_sewa</th>
                                                <th data-field="tgl_pengembalian" data-editable="true">tgl_pengembalian</th>
                                                <th data-field="lama_pinjam" data-editable="true">lama_pinjam</th>
                                                <th data-field="biaya_sewa" data-editable="true">biaya_sewa</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($pesan as $row){
                                                    ...
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_pesan.php?ID_pesan=<?php echo $row['ID_pesan'];?>&ID_pelanggan=<?php echo $row['ID_pelanggan'];?>&tgl_sewa=<?php echo $row['tgl_sewa'];?>&tgl_pengembalian=<?php echo $row['tgl_pengembalian'];?>&lama_pinjam=<?php echo $row['lama_pinjam'];?>&biaya_sewa=<?php echo $row['biaya_sewa'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_pesan.php?ID_pesan=<?php 
                                                                echo $row['ID_pesan'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>RENTAL MOBIL&copy; <a href="https://smkmiftahulhikmah.sch.id">YUSIFA APRILIA</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
