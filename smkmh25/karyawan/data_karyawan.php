                                            ...
                                            <?php
                                                ...
                                                foreach ($karyawan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_karyawan.php?ID_karyawan=<?php echo $row['ID_karyawan'];?>&nama=<?php echo $row['nama'];?>&ttl=<?php echo $row['ttl'];?>&alamat=<?php echo $row['alamat'];?>&jenis_kelamin=<?php echo $row['jenis_kelamin'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
