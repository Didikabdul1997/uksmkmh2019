...
<head>
    ...
    <title>Data Pelanggan | SMK Miftahul Hikmah</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ttl" data-editable="true">ttlL</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($pelanggan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_pelanggan.php?ID_pelanggan=<?php echo $row['ID_pelanggan'];?>&nama=<?php echo $row['nama'];?>&ttl=<?php echo $row['ttl'];?>&alamat=<?php echo $row['alamat'];?>&no.telpon=<?php echo $row['no_telpon'];?>&jenis_kelamin=<?php echo $row['jenis_kelamin'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
