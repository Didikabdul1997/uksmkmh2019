...
<head>
    ...
    <title>Data Penyewa | Dika traivel</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Penyewa</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Penyewa</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Penyewa</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_penyewa.php">Tambah Penyewa</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_penyewa" data-editable="true">id_Penyewa</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($penyewa as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['alamat']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_penyewa.php?id_penyewa=<?php echo $row['id_penyewa'];?>&nama=<?php echo $row['nama'];?>&ttL=<?php echo $row['ttL'];?>&jenis_kelamin=<?php echo $row['jenis_kelamin'];?>&alamat=<?php echo $row['alamat'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_penyewa.php?id_penyewa=<?php echo $row['id_penyewa'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p> &copy;  <a href="https://dika traivel.sch.id">Dika Driver</a> </p>
                        </div>
                    </div>
                </div>
            </div>
