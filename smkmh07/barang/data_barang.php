...
<head>
    ...
    <title>Data barang | nott counter</title>
                                            ...
                                            <?php
                                                ...
                                                foreach ($barang as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_barang.php?id_barang=<?php echo $row['id_barang'];?>&nama_barang=<?php echo $row['nama_barang'];?>&harga=<?php echo $row['harga'];?>&jumlah_stok=<?php echo $row['jumlah_stok'];?>&"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
