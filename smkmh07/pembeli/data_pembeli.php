...
<head>
    ...
    <title>Data pembeli | nott counter</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">pembeli</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data pembeli</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> pembeli</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="nama_barang" data-editable="true">nama_barang</th>
                                                <th data-field="alamat" data-editable="true">alamat</th>
                                                <th data-field="jumlah_barang" data-editable="true">jumlah barang</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($pembeli as $row){
                                                    ...
                                                    echo "<td>".$nama_barang."</td>
                                                        ...
                                                        <td>".$row['total']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_pembeli.php?id_pembeli=<?php echo $row['id_pembeli'];?>&nama_pembeli=<?php echo $row['nama_pembeli'];?>&id_barang=<?php echo $row['id_barang'];?>&alamat=<?php echo $row['alamat'];?>&jumlah_barang=<?php echo $row['jumlah_barang'];?>&total=<?php echo $row['total'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_pembeli.php?id_pembeli=<?php echo $row['id_pembeli'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
