...
<head>
    ...
    <title>Data Transaksi | Toko Buku</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="tgl_pembeli" data-editable="true">tgl_pembeli</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($transaksi as $row){
                                                    echo "<tr>
                                                        <td></td>
                                                        <td>$no</td>
                                                        <td>".$row['tgl_pembeli']."</td>
                                                         <td>".$row['id_transaksi']."</td>
                                                        <td>".$row['kasir']."</td>
                                                        <td>".$row['harga']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_transaksi.php?tgl_pembeli=<?php echo $row['tgl_pembeli'];?>&id_transaksi=<?php echo $row['id_transaksi'];?>&kasir=<?php echo $row['kasir'];?>&harga=<?php echo $row['harga'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_transaksi.php?tgl_pembeli=<?php echo $row['tgl_pembeli'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
