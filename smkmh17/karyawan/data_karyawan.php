...
<head>
    ...
    <title>Data karyawan| Toko Buku</title>
                                            ...
                                            <?php
                                                ...
                                                foreach ($karyawan as $row){
                                                    echo "<tr>
                                                       ...
                                                       <td>
                                                            <a href="edit_karyawan.php?id_karyawan=<?php echo $row['id_karyawan'];?>&nama_karyawan=<?php echo $row['nama_karyawan']
                                                            ;?>&jenis_kelamin=<?php echo $row['jenis_kelamin'];?>&ttl=<?php echo $row['ttl'];?>&alamat=<?php echo $row['alamat'];?>&no_hp=<?php echo $row['no_hp'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
