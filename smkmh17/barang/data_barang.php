                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="judul_buku" data-editable="true">judul_buku</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($barang as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['harga']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_barang.php?id_barang=<?php echo $row['id_barang'];?>&jumlah_barang=<?php echo $row['jumlah_barang'];?>&judul_buku=<?php echo $row['judul_buku'];?>&harga=<?php echo $row['harga'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
