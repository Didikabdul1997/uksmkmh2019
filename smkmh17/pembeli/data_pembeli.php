...
<head>
    ...
    <title>Data Pembeli | Toko Buku</title>
                                            ...
                                            <?php
                                                ...
                                                foreach ($pembeli as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['alamat']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_pembeli.php?id_pembeli=<?php echo $row['id_pembeli'];?>&nama_pembeli=<?php echo $row['nama_pembeli'];?>&jenis_kelamin=<?php echo $row['jenis_kelamin'];?>&alamat=<?php echo $row['alamat'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
