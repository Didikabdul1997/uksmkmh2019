...
<head>
    ...
    <title>Data Siswa | SMK Miftahul Hikmah</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="nisn" data-editable="true">ID Barang</th>
                                                <th data-field="nama" data-editable="true">Nama Barang</th>
                                                <th data-field="ttl" data-editable="true">Harga</th>
												<th data-field="alamat" data-editable="true">Stok</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($siswa as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['stok']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_siswa.php?nisn=<?php echo $row['nisn'];?>&nama=<?php echo $row['nama'];?>&ttl=<?php echo $row['ttl'];?>&alamat=<?php echo $row['alamat'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
