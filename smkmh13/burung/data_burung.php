...
<head>
    ...
    <title>Harga Burung | SMK Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Harga Burung</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Harga Burung</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Harga</span> Burung</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_burung.php">Jual Burung</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id" data-editable="true">ID Pemilik</th>
                                                <th data-field="nama_pmlk" data-editable="true">Nama Pemilik</th>
                                                <th data-field="jns" data-editable="true">Jenis Burung</th>
                                                <th data-field="nama_brg" data-editable="true">Nama Burung</th>
                                                <th data-field="harga" data-editable="true">Harga</th>
                                                <th data-field="telp" data-editable="true">No Telepon</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $burung = mysqli_query($koneksi, "SELECT * from burung");
                                                $no=1;
                                                foreach ($burung as $row){
                                                    echo "<tr>
                                                        <td></td>
                                                        <td>$no</td>
                                                        <td>".$row['id']."</td>
                                                        ...
                                                        <td>".$row['telp']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_burung.php?id=<?php echo $row['id'];?>&nama_pmlk=<?php echo $row['nama_pmlk'];?>&jns=<?php echo $row['jns'];?>&nama_brg=<?php echo $row['nama_brg'];?>&harga=<?php echo $row['harga'];?>&telp=<?php echo $row['telp'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_burung.php?id=<?php echo $row['id'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
