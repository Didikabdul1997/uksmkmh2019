...
<head>
    ...
    <title>Data pegawai |kecamatan parengan</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ID_pegawai"data-editable="true">ID_pegawai</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($pegawai as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['alamat']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_pegawai.php?ID_pegawai=<?php echo $row['ID_pegawai'];?>&nama=<?php echo $row['nama'];?>&ttl=<?php echo $row['ttl'];?>&alamat=<?php echo $row['alamat'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
