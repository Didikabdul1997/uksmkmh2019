...
<head>
    ...
    <title>Edit pegawai |kecamatan parengan</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Edit pegawai</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="all-form-element-inner">
                                                <form action="simpan_edit_pegawai.php" method="post">
                                                    <?php
                                                        ...
                                                        $alamat = $_GET['alamat'];
                                                    ?>
                                                    <input type="hidden" name="ID_pegawaiawal" value="<?php echo $ID_pegawai; ?>"/>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">ID_pegawai</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="ID_pegawai" value="<?php echo $ID_pegawai; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        <a class="btn btn-default" href="data_pegawai.php">Cancel</a>
