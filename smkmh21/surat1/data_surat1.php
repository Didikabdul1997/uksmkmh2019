...
<head>
    ...
    <title>Data surat1|kecamatan parengan</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">surat1</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data surat1</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span>surat1</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_surat1.php">Tambah surat1</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_surat1" data-editable="true">id_surat1</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $surat1= mysqli_query($koneksi, "SELECT * from surat1");
                                                $no=1;
                                                foreach ($surat1 as $row){
                                                    echo "<tr>
                                                        <td></td>   
                                                        <td>$no</td>
                                                        <td>".$row['id_surat1']."</td>
                                                        ...
                                                        <td>".$row['alamat']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_surat1.php?id_surat1=<?php echo $row['id_surat1'];?>&nama=<?php echo $row['nama'];?>&tanggal=<?php echo $row['tanggal'];?>&alamat=<?php echo $row['alamat'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_surat1.php?id_surat1=<?php echo $row['id_surat1'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
