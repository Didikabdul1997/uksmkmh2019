...
<head>
    ...
    <title>stok barang | ELs KOMPUTER</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">barang</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data barang</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">stok</span> barang</h1>
                                </div>
                            </div>
                                            ...
                                            <?php
                                                ...
                                                foreach ($barang as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['harga']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_barang.php?id_barang=<?php echo $row['id_barang'];?>&nama_barang=<?php echo $row['nama_barang'];?>&tgl_pembelian=<?php echo $row['tgl_pembelian'];?>&jumlah=<?php echo $row['jumlah'];?>&harga=<?php echo $row['harga'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_barang.php?nama_barang=<?php echo $row['nama_barang'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">ELs KOMPETER</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
