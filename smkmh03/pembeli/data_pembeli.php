...
<head>
    ...
    <title>Data pembeli | ELs KOMPUTER</title>
                                            ...
                                            <?php
                                                ...
                                                foreach ($pembeli as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['jumlah']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_pembeli.php?id_pembeli=<?php echo $row['id_pembeli'];?>&nama=<?php echo $row['nama'];?>&alamat=<?php echo $row['alamat'];?>&nama_barang=<?php echo $row['nama_barang'];?>&jumlah=<?php echo $row['jumlah'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">ELs KOMPUTER</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
