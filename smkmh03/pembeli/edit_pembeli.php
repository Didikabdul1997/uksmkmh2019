...
<head>
    ...
    <title>Edit pembeli | ELs KOMPUTER</title>
                                                ...
                                                <form action="simpan_edit_pembeli.php" method="post">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="alamat" value="<?php echo $nama_barang; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="nama_barang" value="<?php echo $alamat; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
