                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Nama_Obat" data-editable="true">Nama_Obat</th>
                                                <th data-field="Kegunaan" data-editable="true">Kegunaan</th>
												<th data-field="jumlah_stok" data-editable="true">jumlah_stok</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($Obat as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_Obat.php?id_obat=<?php echo $row['id_obat'];?>&Nama_Obat=<?php echo $row['Nama_Obat'];?>&Nama_Obat=<?php echo $row['Nama_Obat'];?>&Kegunaan=<?php echo $row['Kegunaan'];?>
                                                            &jumlah_stok=<?php echo $row['jumlah_stok'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
