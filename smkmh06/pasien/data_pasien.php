...
<head>
    ...
    <title>Data_pasien | SMK Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">pasien</a> <span class="bread-slash">/</span>
                                            </li>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> pasien</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_pasien" data-editable="true">id_pasien</th>
                                                <th data-field="Nama" data-editable="true">Nama</th>
                                                <th data-field="Jeniskelamin" data-editable="true">Jeniskelamin</th>
												<th data-field="Keluhan" data-editable="true">Keluhan</th>
                                                <th data-field="Alamat" data-editable="true">Alamat</th>
                                                <th data-field="no_kamar" data-editable="true">no_kamar</th>
                                                <th data-field="nama_kamar" data-editable="true">nama_kamar</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($pasien as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_pasien.php?id_pasien=<?php echo $row['id_pasien'];?>&Nama=<?php echo $row['Nama'];?>&Jeniskelamin=<?php echo $row['Jeniskelamin'];?>&Keluhan=<?php echo $row['Keluhan'];?>      &Alamat=<?php echo $row['Alamat'];?>
                                                            &no_kamar=<?php echo $row['no_kamar'];?>
                                                             &nama_kamar=<?php echo $row['nama_kamar'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_pasien.php?id_pasien=<?php echo $row['id_pasien'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">Rumah Sakit Sehat</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
