...
<head>
    ...
    <title>Data dokter | SMK Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">dokter</a> <span class="bread-slash">/</span>
                                            </li>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> dokter</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_dokter" data-editable="true">id_dokter</th>
                                                <th data-field="Nama" data-editable="true">Nama</th>
                                                <th data-field="Keahlian" data-editable="true">Keahlian</th>
												<th data-field="Alamat" data-editable="true">Alamat</th>
                                                <th data-field="jam_kerja" data-editable="true">jam_kerja</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($dokter as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['jam_kerja']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_dokter.php?id_dokter=<?php echo $row['id_dokter'];?>&Nama=<?php echo $row['Nama'];?>&Keahlian=<?php echo $row['Keahlian'];?>&Alamat=<?php echo $row['Alamat'];?>
                                                            &jam_kerja=<?php echo $row['jam_kerja'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_dokter.php?id_dokter=<?php echo $row['id_dokter'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
