...
<head>
    ...
    <title>Data transaksi | GOWER</title>
                                            ...
                                            <?php
                                                ...
                                                foreach ($transaksi as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['tujuan']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_transaksi.php?id_transaksi=<?php echo $row['id_transaksi'];?>&Harga=<?php echo $row['Harga'];?>&tujuan=<?php echo $row['tujuan'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
