...
<head>
    ...
    <title>Data karyawan | GOWER</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_kar">id_kar</th>
												...
												<th data-field="No_hp" data-editable="true">No_hp</th>
                                                <th data-field="No_ktp" data-editable="true">No_ktp</th>
                                                <th data-field="No_kartu_keluarga" data-editable="true">No_kartu_keluarga</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($karyawan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_karyawan.php?id_kar=<?php echo $row['id_kar'];?>&Nama=<?php echo $row['Nama'];?>&Alamat=<?php echo $row['Alamat'];?>&Ttl=<?php echo $row['Ttl'];?>&No_hp=<?php echo $row['No_hp'];?>&No_ktp=<?php echo $row['No_ktp'];?>&No_kartu_keluarga=<?php echo $row['No_kartu_keluarga'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_karyawan.php?id_kar=<?php echo $row['id_kar'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
