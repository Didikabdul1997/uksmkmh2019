...
<head>
    ...
    <title>Data penumpang | GOWER</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">penumpang</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data penumpang</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> penumpang</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_penumpang.php">Tambah penumpang</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_penumpang" data-editable="true">id_penumpang</th>
                                                <th data-field="Nama" data-editable="true">Nama</th>
                                                <th data-field="Alamat" data-editable="true">Alamat</th>
												<th data-field="Tujuan" data-editable="true">Tujuan</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($penumpang as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['Tujuan']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_penumpang.php?id_penumpang=<?php echo $row['id_penumpang'];?>&Nama=<?php echo $row['Nama'];?>&Alamat=<?php echo $row['Alamat'];?>&Tujuan=<?php echo $row['Tujuan'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_penumpang.php?id_penumpang=<?php echo $row['id_penumpang'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://GOWER.co.id">GOWER</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
