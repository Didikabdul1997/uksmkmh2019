                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Kontrakan</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="latest-blog-single blog-single-full-view">
                                        <div class="blog-image">
                                            <a href="#"><img width="900" height="70" src="../assets/img/blog-details/3.jpg" alt="" />
												</a>
                                            <div class="blog-date">
                                        ...
                                        <div class="blog-details blog-sig-details">
                                            <div class="details-blog-dt blog-sig-details-dt">
                                                <span><a href="#"><i class="fa fa-user"></i> By Umii</a></span>
                                                <span><a href="#"><i class="fa fa-heart"></i> 1000 Likes</a></span>
                                                <span><a href="#"><i class="fa fa-comments-o"></i> 10 Comments</a></span>
                                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://Kontrakan.sch.id">Kontrakan Home.</p>
                        </div>
                    </div>
                </div>
            </div>
