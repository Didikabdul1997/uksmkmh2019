...
<head>
    ...
    <title>Data transaksi | kontrakan</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ID_transaksi" data-editable="true">ID_transaksi</th>
                                                <th data-field="tgl_transaksi" data-editable="true">tgl_transaksi</th>
                                                <th data-field="jenis_kontrakan" data-editable="true">jenis kontrakan</th>
                                                <th data-field="lama_menempati" data-editable="true">lama menempati</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($transaksi as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['jenis_kontrakan']."</td>
                                                        <td>".$row['lama_menempati']."</td>
                                                        <td>".$row['harga']."</td>
                                                        <td>".$row['total']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_transaksi.php?ID_transaksi=<?php echo $row['ID_transaksi'];?>&tgl_transaksi=<?php echo $row['tgl_transaksi'];?>&jenis_kontrakan=<?php echo $row['jenis_kontrakan'];?>&lama_menempati=<?php echo $row['lama_menempati'];?>&harga=<?php echo $row['harga'];?>&total=<?php echo $row['total'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_transaksi.php?ID_transaksi=<?php echo $row['ID_transaksi'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">transaksi.</p>
                        </div>
                    </div>
                </div>
            </div>
