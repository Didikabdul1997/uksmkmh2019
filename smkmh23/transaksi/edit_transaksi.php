...
<head>
    ...
    <title>Edit transaksi | kontrakan</title>
                                            ...
                                            <div class="all-form-element-inner">
                                                <form action="simpan_edit_transaksi.php" method="post">
                                                    <?php
                                                        ...
                                                        $jenis_kontrakan    = $_GET['jenis_kontrakan'];
                                                        $lama_menempati   = $_GET['lama_menempati'];
                                                        $harga    = $_GET['harga'];
                                                        $total    = $_GET['total'];
                                                        ?>
                                                    <input type="hidden" name="ID_transaksiawal" value="<?php echo $ID_transaksi; ?>"/>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">tgl_transaksi</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="tgl_transaksi" value="<?php echo $tgl_transaksi; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">jenis kontrakan</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="jenis_kontrakan" value="<?php echo $jenis_kontrakan; ?>" class="form-control" />
                                                             </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">lama menempati</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="lama_menempati" value="<?php echo $lama_menempati; ?>" class="form-control" />
                                                             </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        <a class="btn btn-default" href="data_transaksi.php">Cancel</a>
