...
<head>
    ...
    <title>Data customer | kontrakan</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Data customer</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> customer</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list customer-datatable-overright">
                                    <div id="toolbar">
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $siswa = mysqli_query($koneksi, "SELECT * from customer");
                                                $no=1;
                                                foreach ($siswa as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['Alamat']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_customer.php?ID_customer=<?php echo $row['ID_customer'];?>&Nama_Lengkap=<?php echo $row['Nama_Lengkap'];?>&TTL=<?php echo $row['TTL'];?>&Alamat=<?php echo $row['Alamat'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_customer.php?ID_customer=<?php echo $row['ID_customer'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">customer.</p>
                        </div>
                    </div>
                </div>
            </div>
