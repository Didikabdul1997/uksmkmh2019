...
<head>
    ...
    <title>Data kontrakan | SMK Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">kontrakan</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data kontrakan</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> kontrakan</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_kontrakan.php">Tambah kontrakan</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Jenis_kontrakan" data-editable="true">Jenis_kontrakan</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $kontrakan = mysqli_query($koneksi, "SELECT * from kontrakan");
                                                $no=1;
                                                foreach ($kontrakan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['harga']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_kontrakan.php?id_kontrakan=<?php echo $row['id_kontrakan'];?>&Jenis_kontrakan=<?php echo $row['Jenis_kontrakan'];?>&harga=<?php echo $row['harga'];?>& 
                                                                "><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_kontrakan.php?id_kontrakan=<?php echo $row['id_kontrakan'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">kontrakan.</p>
                        </div>
                    </div>
                </div>
            </div>
