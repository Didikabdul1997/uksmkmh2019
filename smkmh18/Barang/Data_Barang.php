...
<head>
    ...
    <title>Data barang | kantin</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="../assets/img/logo/FD.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                            ...
                                            <?php
                                                ...
                                                foreach ($barang as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['Harga']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_barang.php?ID_Barang=<?php echo $row['ID_Barang'];?>&Nama_Barang=<?php echo $row['Nama_Barang'];?>&Stok=<?php echo $row['Stok'];?>&Harga=<?php echo $row['Harga'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
