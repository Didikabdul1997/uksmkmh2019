...
<head>
    ...
    <title>Data pembeli | kantin</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ID_Pembeli" data-editable="true">ID Pembeli</th>
                                                <th data-field="Nama_Barang" data-editable="true">Nama Barang</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($pembeli as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['Jumlah']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_Pembeli.php?ID_Pembeli=<?php echo $row['ID_Pembeli'];?>&Nama_Barang=<?php echo $row['Nama_Barang'];?>&Harga=<?php echo $row['Harga']?>&Jumlah=<?php echo $row['Jumlah'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
