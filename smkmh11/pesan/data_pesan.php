...
<head>
    ...
    <title>Data pesan | KURNIA RESTORAN</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="makanan" data-editable="true">makanan</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($pesan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['makanan']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_pesan.php?id_pesan=<?php echo $row['id_pesan'];?>&pelanggan=<?php echo $row['pelanggan'];?>&makanan=<?php echo $row['makanan'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_pesan.php?id_pesan=<?php echo $row['id_pesan'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>RESTORAN &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">KURNIA RESTORAN</a> PILIHAN ANDA.</p>
                        </div>
                    </div>
                </div>
            </div>
