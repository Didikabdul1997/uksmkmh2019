...
<head>
    ...
    <title>Data Karyawan | KURNIA Restor</title>
                                            ...
                                            <?php
                                                ...
                                                foreach ($karyawan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['ttl']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_karyawan.php?id_karyawan=<?php echo $row['id_karyawan'];?>&nama_karyawan=<?php echo $row['nama_karyawan'];?>&no_hp=<?php echo $row['no_hp'];?>&ttl=<?php echo $row['ttl'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
