...
<head>
    ...
    <title>Data pelanggan | KURNIA RESTORAN</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">pelanggan</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data pelanggan/span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_pelanggan" data-editable="true">id_pelanggan</th>
                                                <th data-field="nama_pelanggan" data-editable="true">nama_pelanggan</th>
												<th data-field="alamat_pelanggan" data-editable="true">alamat_pelanggan</th>
                                                <th data-field="no_telpon" data-editable="true">no_telpon</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $pelanggan = mysqli_query($koneksi, "SELECT * from pelangan");
                                                $no=1;
                                                 foreach ($pelanggan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['no_telpon']."</td>"; ?>
                                                        <td>
                                                             <a href="edit_pelanggan.php?id_pelanggan=<?php echo $row['id_pelanggan'];?>&nama_pelanggan=<?php echo $row['nama_pelanggan'];?>&alamat_pelanggan=<?php echo $row['alamat_pelanggan'];?>&no_telpon=<?php echo $row['no_telpon'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_pelanggan.php?id_pelanggan=<?php echo $row['id_pelanggan'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">KURNIA RESTORAN</a> PILIHAN ANDA.</p>
                        </div>
                    </div>
                </div>
            </div>
