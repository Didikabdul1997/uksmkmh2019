...
<head>
    ...
    <title>Data Makanan | KURNIA RESTORAN</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Makanan</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Makanan</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Makanan</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_makanan.php">Tambah Makanan</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_makanan" data-editable="true">Id_makanan</th>
                                                <th data-field="nama" data-editable="true">nama</th>
												<th data-field="harga_Makanan" data-editable="true">harga_makanan</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($makanan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_makanan.php?id_makanan=<?php echo $row['id_makanan'];?>&nama=<?php echo $row['nama'];?>&harga_makanan=<?php echo $row['harga_makanan'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_makanan.php?id_makanan=<?php echo $row['id_makanan'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
