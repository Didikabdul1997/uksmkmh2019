...
<head>
    ...
    <title>Data Karyawan | SMK Miftahul Hikmah</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_karyawan">ID Karyawan</th>
                                                <th data-field="nama_karyawan" data-editable="true">Nama Karyawan</th>
                                                <th data-field="alamat" data-editable="true">Alamat</th>
                                                <th data-field="no_telp" data-editable="true">No Telp</th>
												<th data-field="bagian" data-editable="true">Bagian</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($karyawan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['bagian']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_Karyawan.php?id_karyawan=<?php echo $row['id_karyawan'];?>&nama_karyawan=<?php echo $row['nama_karyawan'];?>&alamat=<?php echo $row['alamat'];?>&no_telp=<?php echo $row['no_telp'];?>&bagian=<?php echo $row['bagian'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">INDONESIAN COOPERATIVE</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
