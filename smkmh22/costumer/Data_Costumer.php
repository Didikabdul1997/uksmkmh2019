...
<head>
    ...
    <title>Data Costumer | SMK Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Costumer</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Costumer</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Costumer</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_Costumer.php">Tambah Costumer</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="kode_costumer">Kode_Costumer</th>
                                                <th data-field="tgl_beli" data-editable="true">Tgl_Beli</th>
                                                <th data-field="nama_costumer" data-editable="true">Nama_Costumer</th>
                                                <th data-field="alamat" data-editable="true">Alamat</th>
												<th data-field="no_telp" data-editable="true">No_Telp</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                foreach ($costumer as $row){
                                                    echo "<tr>
                                                        <td></td>
                                                        <td>".$row['kode_costumer']."</td>
                                                        <td>".$row['tgl_beli']."</td>
                                                        <td>".$row['nama_costumer']."</td>
                                                        <td>".$row['alamat']."</td>
                                                        <td>".$row['no_telp']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_Costumer.php?kode_costumer=<?php echo $row['kode_costumer'];?>&tgl_beli=<?php echo $row['tgl_beli'];?>&nama_costumer=<?php echo $row['nama_costumer'];?>&alamat=<?php echo $row['alamat'];?>&no_telp=<?php echo $row['no_telp'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_Costumer.php?kode_costumer=<?php echo $row['kode_costumer'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">INDONESIAN COOPERATIVES</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
