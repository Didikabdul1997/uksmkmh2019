...
<head>
    ...
    <title>Data Barang | SMK Miftahul Hikmah</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="kode_barang">Kode_Barang</th>
                                                <th data-field="jenis_barang" data-editable="true">Jenis_Barang</th>
                                                <th data-field="jumlah_barang" data-editable="true">Jumlah_barang</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($barang as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['jumlah']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_Barang.php?kode_barang=<?php echo $row['kode_barang'];?>&jenis_barang=<?php echo $row['jenis_barang'];?>&jumlah_barang=<?php echo $row['jumlah_barang'];?>&harga=<?php echo $row['harga'];?>&jumlah=<?php echo $row['jumlah'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_Barang.php?kode_barang=<?php echo $row['kode_barang'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
