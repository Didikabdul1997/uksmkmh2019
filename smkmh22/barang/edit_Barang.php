...
<head>
    ...
    <title>Edit Barang | SMK Miftahul Hikmah</title>
                                            ...
                                            <div class="all-form-element-inner">
                                                <form action="simpan_edit_Barang.php" method="post">
                                                    <?php
                                                        ...
                                                        $jumlah = $_GET['jumlah'];
                                                    ?>
                                                    <input type="hidden" name="kode_barangawal" value="<?php echo $kode_barang; ?>"/>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Jenis_Barang</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="jenis_barang" value="<?php echo $jenis_barang; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="jumlah_barang" value="<?php echo $jumlah; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
