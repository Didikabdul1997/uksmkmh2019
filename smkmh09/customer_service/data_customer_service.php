...
<head>
    ...
    <title>Data customer_service | Radifa Motor</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">customer_service</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data customer_service</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> customer_service</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_customer_service.php">Tambah customer_service</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ID_customer_service" data-editable="true">ID_customer_service</th>
                                                <th data-field="Nama" data-editable="true">Nama</th>
                                                <th data-field="Alamat" data-editable="true">Alamat</th>
                                                <th data-field="Jenis_Kelamin" data-editable="true">Jenis_Kelamin</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $customer_service = mysqli_query($koneksi, "SELECT * from customer_service");
                                                $no=1;
                                                foreach ($customer_service as $row){
                                                    echo "<tr>
                                                        <td></td>
                                                        <td>$no</td>
                                                        <td>".$row['ID_customer_service']."</td>
                                                        <td>".$row['Nama']."</td>
                                                        <td>".$row['Alamat']."</td>
                                                        <td>".$row['Jenis_Kelamin']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_customer_service.php?ID_customer_service=<?php echo $row['ID_customer_service'];?>&Nama=<?php echo $row['Nama'];?>&Alamat=<?php echo $row['Alamat'];?>&Jenis_Kelamin=<?php echo $row['Jenis_Kelamin'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_customer_service.php?ID_customer_service=<?php echo $row['ID_customer_service'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
