...
<head>
    ...
    <title>Data Beli | Radifa Motor</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Beli</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Beli</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Beli</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_Beli.php">Tambah_Beli</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ID_Customer" data-editable="true">ID_Customer</th>
                                                <th data-field="ID_Customer_Service" data-editable="true">ID_Customer_Service</th>
                                                <th data-field="Tanggal_Beli" data-editable="true">Tanggal_Beli</th>
												<th data-field="Total_Bayar" data-editable="true">Total Bayar</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($beli as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_beli.php?ID_Customer=<?php echo $row['ID_Customer'];?>&ID_Customer_Service=<?php echo $row['ID_Customer_Service'];?>&Tanggal_Beli=<?php echo $row['Tanggal_Beli'];?>&Total_Bayar=<?php echo $row['Total_Bayar'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_beli.php?ID_Customer=<?php echo $row['ID_Customer'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
