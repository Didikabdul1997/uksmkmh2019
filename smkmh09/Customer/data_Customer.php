...
<head>
    ...
    <title>Data Customer | Radifa Motor</title>
                                            ...
                                            <?php
                                                ...
                                                foreach ($Customer as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_Customer.php?ID_Customer=<?php echo $row['ID_Customer'];?>&Nama=<?php echo $row['Nama'];?>&Alamat=<?php echo $row['Alamat'];?>&Jenis_Kelamin=<?php echo $row['Jenis_Kelamin'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
