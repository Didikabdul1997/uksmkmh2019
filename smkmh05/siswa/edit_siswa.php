...
<head>
    ...
    <title>Edit Siswa | UKS SMK MH</title>
                                            ...
                                            <div class="all-form-element-inner">
                                                <form action="simpan_edit_siswa.php" method="post">
                                                    <?php
                                                        ...
                                                        $resep = $_GET['resep'];
                                                    ?>
                                                    <input type="hidden" name="nisnawal" value="<?php echo $nisn; ?>"/>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="nisn" value="<?php echo $nisn; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Obat</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="obat" value="<?php echo $obat; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        <a class="btn btn-default" href="data_siswa.php">Cancel</a>
