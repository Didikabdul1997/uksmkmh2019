...
<head>
    ...
    <title>Data Siswa | UKS SMK MH</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Siswa</a> <span class="bread-slash">/</span>
                                            </li>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Siswa</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="nisn" data-editable="true">NISN</th>
                                                ...
                                                <th data-field="obat" data-editable="true">Obat</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($siswa as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['resep']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_siswa.php?nisn=<?php echo $row['nisn'];?>&nama=<?php echo $row['nama'];?>&ttl=<?php echo $row['ttl'];?>&jenis_kelamin=<?php echo $row['jenis_kelamin'];?>&kelas=<?php echo $row['kelas'];?>&alamat=<?php echo $row['alamat'];?>&tanggal=<?php echo $row['tanggal'];?>&keluhan=<?php echo $row['keluhan'];?>&obat=<?php echo $row['obat'];?>&resep=<?php echo $row['resep'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_siswa.php?nisn=<?php echo $row['nisn'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
