...
<head>
    ...
    <title>Data Kader | UKS SMK MH</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Kader</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Kader</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Kader</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_kader.php">Tambah Kader</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_kader" data-editable="true">Id Kader</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $kader = mysqli_query($koneksi, "SELECT * from kader");
                                                $no=1;
                                                foreach ($kader as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['alamat']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_kader.php?id_kader=<?php echo $row['id_kader'];?>&nama=<?php echo $row['nama'];?>&ttl=<?php echo $row['ttl'];?>&jenis_kelamin=<?php echo $row['jenis_kelamin'];?>&kelas=<?php echo $row['kelas'];?>&alamat=<?php echo $row['alamat'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_kader.php?id_kader=<?php echo $row['id_kader'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
