...
<head>
    ...
    <title>Kelola Akun | UKS SMK MH</title>
                          ...
                          <form action="../akun/simpan_akun.php" method="post" id="loginForm">
                              ...
                              <div class="row">
                                  <div class="form-group col-lg-12">
                                      ...
                                      <input name="username" value="<?php echo $_SESSION['username'];?>" class="form-control">
                                  </div>
                                  ...
                                  <div class="form-group col-lg-12">
                                      ...
                                      <input name="nama" value="<?php echo $_SESSION['nama'];?>" class="form-control">
                                  </div>
