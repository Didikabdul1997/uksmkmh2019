...
<head>
    ...
    <title>Data Obat | UKS SMK MH</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="../assets/img/logo/slogan.jpg" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Obat</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Obat</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Obat</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_obat" data-editable="true">Id Obat</th>
                                                <th data-field="nama_obat" data-editable="true">Nama Obat</th>
                                                <th data-field="indikasi" data-editable="true">Indikasi</th>
                                                <th data-field="resep" data-editable="true">Resep</th>
                                                <th data-field="stok" data-editable="true">Stok</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($obat as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['stok']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_obat.php?id_obat=<?php echo $row['id_obat'];?>&nama_obat=<?php echo $row['nama_obat'];?>&indikasi=<?php echo $row['indikasi'];?>&resep=<?php echo $row['resep'];?>&stok=<?php echo $row['stok'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_obat.php?id_obat=<?php echo $row['id_obat'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
