...
<head>
    ...
    <title>Data data penjualan | Apotek</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">data penjualan</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data data penjualan</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> data penjualan</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_data_penjualan.php">Tambah data penjualan</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Kode_Transaksi" data-editable="true">Kode_Transaksi</th>
                                                <th data-field="Tanggal" data-editable="true">Tanggal</th>
                                                <th data-field="Id_Pembeli" data-editable="true">Id_Pembeli</th>
												<th data-field="Id_Karyawan" data-editable="true">Id_Karyawan</th>
                                                <th data-field="Id_Obat" data-editable="true">Id_Obat</th>
                                                <th data-field="Jumlah_Obat" data-editable="true">Jumlah_Obat</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $data_penjualan = mysqli_query($koneksi, "SELECT * from data_penjualan");
                                                $no=1;
                                                foreach ($data_penjualan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['Total']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_data_penjualan.php?Kode_Transaksi=<?php echo $row['Kode_Transaksi'];?>&Tanggal=<?php echo $row['Tanggal'];?>&Id_Pembeli=<?php echo $row['Id_Pembeli'];?>&Id_Karyawan=<?php echo $row['Id_Karyawan'];?>&Id_Obat=<?php echo $row['Id_Obat'];?>&Jumlah_Obat=<?php echo $row['Jumlah_Obat'];?>&Total=<?php echo $row['Total'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_data_penjualan.php?Kode_Transaksi=<?php echo $row['Kode_Transaksi'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Hak Cipta &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">Apotek</a> Yudi.</p>
                        </div>
                    </div>
                </div>
            </div>
