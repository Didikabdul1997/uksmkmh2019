...
<head>
    ...
    <title>Data pembeli | Apotek</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Barang_Yang_DiBeli" data-editable="true">Barang_Yang_DiBeli</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($pembeli as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_pembeli.php?Id_Pembeli=<?php echo $row['Id_Pembeli'];?>&Nama=<?php echo $row['Nama'];?>&Barang_Yang_DiBeli=<?php echo $row['Barang_Yang_DiBeli'];?>&Jenis_Kelamin=<?php echo $row['Jenis_Kelamin'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
