                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Jenis_Obat" data-editable="true">Jenis_Obat</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($obat as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['Harga']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_obat.php?Id_Obat=<?php echo $row['Id_Obat'];?>&Nama_Obat=<?php echo $row['Nama_Obat'];?>&Jenis_Obat=<?php echo $row['Jenis_Obat'];?>&Stock=<?php echo $row['Stock'];?>&Harga=<?php echo $row['Harga'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
