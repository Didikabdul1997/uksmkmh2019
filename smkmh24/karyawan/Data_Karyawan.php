...
<head>
    ...
    <title>Data Karyawan | Apotek</title>
                                            ...
                                            <?php
                                                ...
                                                foreach ($Karyawan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['No_Telp']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_Karyawan.php?Id_Karyawan=<?php echo $row['Id_Karyawan'];?>&Nama_Karyawan=<?php echo $row['Nama_Karyawan'];?>&TTL=<?php echo $row['TTL'];?>&Alamat=<?php echo $row['Alamat'];?>&Jenis_Kelamin=<?php echo $row['Jenis_Kelamin'];?>&No_Telp=<?php echo $row['No_Telp'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
