...
<head>
    ...
    <title>Data Bioskop | AFIFATUL CINEMAXX</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Film</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Tabel Film</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Film</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Judul_film" data-editable="true">Judul Film</th>
                                                <th data-field="Jenis_film" data-editable="true">Jenis Film</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($film as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_film.php?Kode_film=<?php echo $row['Kode_film'];?>&Judul_film=<?php echo $row['Judul_film'];?>&Jenis_film=<?php echo $row['Jenis_film'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_film.php?Kode_film=<?php echo $row['Kode_film'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
