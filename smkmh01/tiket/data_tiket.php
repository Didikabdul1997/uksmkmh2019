...
<head>
    ...
    <title>Data Tiket| SMK Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Tiket</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Tiket</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Tiket</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_tiket.php">Tambah Tiket</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Kode_film" data-editable="true">Kode Film</th>
                                                <th data-field="Kode_studio" data-editable="true">Kode Studio</th>
                                                <th data-field="harga_tiket" data-editable="true">Harga Tiket</th>
												<th data-field="tayang" data-editable="true">Tayang</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($tiket as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>$no</td>
                                                        <td>".$row['Kode_film']."</td>
                                                        <td>".$row['Kode_studio']."</td>
                                                        <td>".$row['harga_tiket']."</td>
                                                        <td>".$row['tayang']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_tiket.php?Kode_film=<?php echo $row['Kode_film'];?>&Kode_studio=<?php echo $row['Kode_studio'];?>&harga_tiket=<?php echo $row['harga_tiket'];?>&tayang=<?php echo $row['tayang'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_tiket.php?Kode_film=<?php echo $row['Kode_film'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
