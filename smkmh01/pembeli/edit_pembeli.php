...
<head>
    ...
    <title>Edit Customer | AFIFATUL CINEMAXX</title>
                                            ...
                                            <div class="all-form-element-inner">
                                                <form action="simpan_edit_pembeli.php" method="post">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Nama Customer</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="no_telepon" value="<?php echo $no_telepon; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
