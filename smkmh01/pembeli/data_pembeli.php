...
<head>
    ...
    <title>Data Customer | AFIFATUL CINEMAXX</title>
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_pembeli.php">Tambah Customer</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="nama_pembeli" data-editable="true">Nama pembeli</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($Pembeli as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_pembeli.php?id_pembeli=<?php echo $row['id_pembeli'];?>&nama_pembeli=<?php echo $row['nama_pembeli'];?>&alamat=<?php echo $row['alamat'];?>&no_telepon=<?php echo $row['no_telepon'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
