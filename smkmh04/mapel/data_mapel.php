...
<head>
    ...
    <title>Data Mapel | SMK Miftahul Hikmah</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- favicon
		============================================ -->
        <link rel="shortcut icon" type="image/x-icon" href="../assets/img/3.ico">
    <!-- Google Fonts
		============================================ -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Mapel</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Mapel</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data mapel</span> </h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ID_MAPEL" data-editable="true">ID_MAPEL</th>
                                                <th data-field="NAMAMAPEL" data-editable="true">NAMAMAPEL</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($mapel as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['NAMAMAPEL']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_mapel.php?ID_MAPEL=<?php echo $row['ID_MAPEL'];?>&NAMAMAPEL=<?php echo $row['NAMAMAPEL'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_mapel.php?ID_MAPEL=<?php echo $row['ID_MAPEL'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
