...
<head>
    ...
    <title>Data Jurusan | SMK Miftahul Hikmah</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- favicon
		============================================ -->
        <link rel="shortcut icon" type="image/x-icon" href="../assets/img/5.ico">
    <!-- Google Fonts
		============================================ -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Jurusan</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Jurusan</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Jurusan</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="CODE_JUR" data-editable="true">CODE_JUR</th>
                                                <th data-field="NAMAJURUSAN" data-editable="true">NAMA JURUSAN</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($jurusan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_jurusan.php?CODE_JUR=<?php echo $row['CODE_JUR'];?>&NAMAJURUSAN=<?php echo $row['NAMAJURUSAN'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_jurusan.php?CODE_JUR=<?php echo $row['CODE_JUR'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
