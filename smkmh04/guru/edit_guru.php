...
<head>
    ...
    <title>Edit Guru | SMK Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">SGuru</a> <span class="bread-slash">/</span>
                                            </li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="simpan_edit_guru.php" method="post">
                                                    <?php
                                                        $NIP   = $_GET['NIP'];
                                                        $Nama   = $_GET['Nama'];
                                                        $ttl    = $_GET['TTL'];
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        <a class="btn btn-default" href="data_guru.php">Cancel</a>
