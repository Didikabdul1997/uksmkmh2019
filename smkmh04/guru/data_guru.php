...
<head>
    ...
    <!-- favicon
		============================================ -->
        <link rel="shortcut icon" type="image/x-icon" href="../assets/img/4.ico">
    <!-- Google Fonts
		============================================ -->
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Guru</h1>
                                </div>
                            </div>
                                            ...
                                            <?php
                                                ...
                                                foreach ($siswa as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['ALAMAT']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_guru.php?NIP=<?php echo $row['NIP'];?>&Nama=<?php echo $row['NAMA'];?>&TTL=<?php echo $row['TTL'];?>&Alamat=<?php echo $row['ALAMAT'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_guru.php?NIP=<?php echo $row['NIP'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
