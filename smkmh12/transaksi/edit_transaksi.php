...
<head>
    ...
    <title>Edit transaksi | alfamaret</title>
                                            ...
                                            <div class="all-form-element-inner">
                                                <form action="simpan_edit_transaksi.php" method="post">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">tanggal_transaksi</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="tanggal_transaksi" value="<?php echo $tanggal_transaksi; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">pembeli</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="pembeli" value="<?php echo $pembeli; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                            <select class="form-control custom-select-value" name="barang">
                                                        <?php
                                                            ...
                                                            foreach ($barang as $row){
                                                                ...
                                                                $id_baranga = $row['id_barang'];
                                                                $nama_barang = $row['nama_barang'];
                                                                echo "<option value='$id_baranga' $sel >$nama_barang</option>";
                                                            }
                                                        ?>
