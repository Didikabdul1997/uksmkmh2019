...
<head>
    ...
    <title>Data transaksi  | alfamaret</title>
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_transaksi.php">Tambah_transaksi</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="tanggal_transaksi" data-editable="true">tanggal_transaksi</th>
                                                <th data-field="kasir" data-editable="true">kasir</th>
                                                <th data-field="pembeli" data-editable="true">pembeli</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($transaksi as $row){
                                                    ...
                                                    echo "<tr>
                                                        ...
                                                        <td>".$nama_barang."</td>"; ?>
                                                        <td>
                                                            <a href="edit_transaksi.php?id_transaksi=<?php echo $row['id_transaksi'];?>&tanggal_transaksi=<?php echo $row['tanggal_transaksi'];?>&kasir=<?php echo $row['kasir'];?>&pembeli=<?php echo $row['pembeli'];?>&id_barang=<?php echo $id_barang;?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
