...
<head>
    ...
    <title>Data barang | alfamaret</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="stok_barang" data-editable="true">stok_barang</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($barang as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_barang.php?id_barang=<?php echo $row['id_barang'];?>&nama_barang=<?php echo $row['nama_barang'];?>&stok_barang=<?php echo $row['stok_barang'];?>&harga=<?php echo $row['harga'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
