        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="../assets/img/logo/LILA.jpg" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="latest-blog-single blog-single-full-view">
                                        <div class="blog-image">
                                            <a href="#"><img width="1100" height="800" src="../assets/img/blog-details/2.jpg" alt="" />
												</a>
                                            <div class="blog-date">
                                                <p><span class="blog-day">27</span> sep</p>
                                            </div>
                                        </div>
                                        <div class="blog-details blog-sig-details">
                                            <div class="details-blog-dt blog-sig-details-dt">
                                                <span><a href="#"><i class="fa fa-user"></i> By lila kusniyatin</a></span>
                                                <span><a href="#"><i class="fa fa-heart"></i> 7000 jt Likes</a></span>
                                                <span><a href="#"><i class="fa fa-comments-o"></i> 100 Comments</a></span>
                                            </div>
                                            <h1><a class="blog-ht" href="#">alfamaret</a></h1>
                                            <p>adalah jaringan toko swalayan yang memiliki banyak cabang di Indonesia. Gerai ini umumnya menjual berbagai produk makanan, minuman dan barang kebutuhan hidup lainnya. Lebih dari 200 produk makanan dan barang kebutuhan hidup lainnya tersedia dengan harga bersaing, memenuhi kebutuhan konsumen sehari-hari.
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>lilamarket &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">alfamaret</a> lilo.</p>
                        </div>
                    </div>
                </div>
            </div>
