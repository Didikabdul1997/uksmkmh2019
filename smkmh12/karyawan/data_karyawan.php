...
<head>
    ...
    <title>Data karyawan | alfamaret</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="telepon" data-editable="true">telepon</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($karyawan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_karyawan.php?id_karyawan=<?php echo $row['id_karyawan'];?>&nama_karyawan=<?php echo $row['nama_karyawan'];?>&alamat=<?php echo $row['alamat'];?>&ttl=<?php echo $row['ttl'];?>&telepon=<?php echo $row['telepon'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
