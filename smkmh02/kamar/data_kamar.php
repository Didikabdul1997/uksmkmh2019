                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">kamar</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data kamar</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> kamar</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
												...
												<th data-field="ID_service" data-editable="true">ID service</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($kamar as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_kamar.php?No_kamar=<?php echo $row['No_kamar'];?>&status=<?php echo $row['status'];?>&harga=<?php echo $row['harga'];?>&ID_service=<?php echo $row['ID_service'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_kamar.php?No_kamar=<?php echo $row['No_kamar'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
