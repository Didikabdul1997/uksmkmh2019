                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ID_transaksi" data-editable="true">ID transaksi</th>
                                                <th data-field="No_kamar" data-editable="true">No kamar</th>
												<th data-field="Lama_inap" data-editable="true">Lama inap</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($transaksi as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_transaksi.php?ID_transaksi=<?php echo $row['ID_transaksi'];?>&No_kamar=<?php echo $row['No_kamar'];?>&Lama_inap=<?php echo $row['Lama_inap'];?>&total_harga=<?php echo $row['total_harga'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
