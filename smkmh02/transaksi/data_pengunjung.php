...
<head>
    ...
    <title>GRAND ARABIA HOTEL</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">pengunjung</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data pengunjung</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> pengunjung</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_pengunjung.php">Tambah pengunjung</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ID_pengunjung" data-editable="true">ID pengunjung</th>
                                                <th data-field="Nama_pengunjung" data-editable="true">Nama pengunjung</th>
                                                <th data-field="Alamat_pengunjung" data-editable="true">Alamat pengunjung</th>
												<th data-field="No_telp" data-editable="true">No telp</th>
                                                <th data-field="No_ktp" data-editable="true">No ktp</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($pengunjung as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['No_ktp']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_pengunjung.php?ID_pengunjung=<?php echo $row['ID_pengunjung'];?>&Nama_pengunjung=<?php echo $row['Nama_pengunjung'];?>&Alamat_pengunjung=<?php echo $row['Alamat_pengunjung'];?>&No_telp=<?php echo $row['No_telp'];?>&No_ktp=<?php echo $row['No_ktp'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_pengunjung.php?ID_pengunjung=<?php echo $row['ID_pengunjung'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">GRAND ARABIA HOTEL</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
