                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">petugas</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data petugas</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> petugas</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ID_petugas" data-editable="true">ID petugas</th>
                                                <th data-field="Nama_petugas" data-editable="true">Nama petugas</th>
                                                <th data-field="Jabatan_petugas" data-editable="true">Jabatan petugas</th>
												</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($petugas as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_petugas.php?ID_petugas=<?php echo $row['ID_petugas'];?>&Nama_petugas=<?php echo $row['Nama_petugas'];?>&Jabatan_petugas=<?php echo $row['Jabatan_petugas'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_petugas.php?ID_petugas=<?php echo $row['ID_petugas'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">GRAND ARABIA HOTEL</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
