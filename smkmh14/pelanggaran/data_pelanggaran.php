...
<head>
    ...
    <title>Data Pelanggaran | PONPES Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Data Pelanggaran</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Pelanggaran</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_pelanggaran.php">Tambah Pelanggaran</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="nis">Nama Santri</th>
                                                <th data-field="nisn" data-editable="true">Nama Pelanggaran</th>
                                                <th data-field="nama" data-editable="true">TGL Pelanggaran</th>
                                                <th data-field="ttl" data-editable="true">JAM Pelanggaran</th>
												<th data-field="alamat" data-editable="true">Sanksi</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                foreach ($pelanggaran as $row){
                                                    $nis = $row['nis'];
                                                    $santri = mysqli_query($koneksi, "SELECT * from santri where nis='$nis'");
                                                    foreach ($santri as $san){
                                                        $nama_santri = $san['nama'];
                                                    }
                                                    $id_sanksi = $row['id_sanksi'];
                                                    $sanksi = mysqli_query($koneksi, "SELECT * from sanksi where id_sanksi='$id_sanksi'");
                                                    foreach ($sanksi as $san){
                                                        $nama_sanksi = $san['nama_sanksi'];
                                                    }
                                                    echo "<tr>
                                                        <td></td>
                                                        <td>$no</td>
                                                        ...
                                                        <td>".$row['tgl_pelanggaran']."</td>
                                                        <td>".$row['jam_pelanggaran']."</td>
                                                        <td>".$nama_sanksi."</td>"; ?>
                                                        <td>
                                                            <a href="edit_pelanggaran.php?id_pelanggaran=<?php echo $row['id_pelanggaran'];?>&nis=<?php echo $row['nis'];?>&nama_pelanggaran=<?php echo $row['nama_pelanggaran'];?>&tgl_pelanggaran=<?php echo $row['tgl_pelanggaran'];?>&jam_pelanggaran=<?php echo $row['jam_pelanggaran'];?>&id_sanksi=<?php echo $row['id_sanksi'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_pelanggaran.php?id_pelanggaran=<?php echo $row['id_pelanggaran'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
