...
<head>
    ...
    <title>Data Sanksi| PONPES Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Sanksi</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Sanksi</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Sanksi</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_sanksi.php">Tambah Sanksi</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_sanksi" data-editable="true">ID Sanksi</th>
                                                <th data-field="nama_sanksi" data-editable="true">Nama Sanksi</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($sanksi as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_sanksi.php?id_sanksi=<?php echo $row['id_sanksi'];?>&nama_sanksi=<?php echo $row['nama_sanksi'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_sanksi.php?id_sanksi=<?php echo $row['id_sanksi'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
