...
<head>
    ...
    <title>Edit Sanksi | PONPES Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Edit Sanksi</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="simpan_edit_sanksi.php" method="post">
                                                    <?php
                                                        $id_sanksi   = $_GET['id_sanksi'];
                                                        $nama_sanksi   = $_GET['nama_sanksi'];
                                                    ?>
                                                    <input type="hidden" name="id_sanksi" value="<?php echo $id_sanksi; ?>"/>
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Nama Sanksi</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="nama_sanksi" value="<?php echo $nama_sanksi; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left">
                                                                        <a class="btn btn-default" href="data_sanksi.php">Cancel</a>
