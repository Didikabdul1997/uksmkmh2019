...
<head>
    ...
    <title>Data Santri | PONPES Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Santri</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Santri</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Santri</h1>
                                </div>
                            </div>
                                            ...
                                            <?php
                                                ...
                                                foreach ($santri as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['alamat']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_santri.php?nis=<?php echo $row['nis'];?>&nama=<?php echo $row['nama'];?>&ttl=<?php echo $row['ttl'];?>&alamat=<?php echo $row['alamat'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_santri.php?nis=<?php echo $row['nis'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
