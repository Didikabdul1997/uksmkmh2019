...
<head>
    ...
    <title>Data Bidan | PUSKESMAS KEREN</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Bidan</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Bidan</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> Bidan</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_bidan.php">Tambah Bidan</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="ID_Bidan" data-editable="true">ID_Bidan</th>
                                                <th data-field="nama" data-editable="true">Nama</th>
												<th data-field="Alamat" data-editable="true">Alamat</th>
                                                <th data-field="jenis_kelamin">jenis_kelamin</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $Bidan = mysqli_query($koneksi, "SELECT * from Bidan");
                                                $no=1;
                                                foreach ($Bidan as $row){
                                                    echo "<tr>
                                                        ...
                                                        ; ?>
                                                        <td>
                                                            <a href="edit_bidan.php?ID_Bidan=<?php echo $row['ID_Bidan'];?>&Nama=<?php echo $row['Nama'];?>&Alamat=<?php echo $row['Alamat'];?>&jenis_kelamin=<?php echo $row['jenis_kelamin'];?>&Spesialis=<?php echo $row['Spesialis'];?>"
                                                            ><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_bidan.php?ID_Bidan=<?php echo $row['ID_Bidan'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p> <b>"Dont Forget Smile" <a href="https://smkmiftahulhikmah.sch.id">SMK Miftahul Hikmah</a> Mei Melinda sari.</p>
                        </div>
                    </div>
                </div>
            </div>
