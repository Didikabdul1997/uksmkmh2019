...
<head>
    ...
    <title>Data obat | SMK Miftahul Hikmah</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="kode_obat" data-editable="true">kode_obat</th>
                                                <th data-field="Nama" data-editable="true">Nama</th>
                                                <th data-field="kegunaan" data-editable="true">kegunaan</th>
												<th data-field="stok" data-editable="true">stok</th>
                                                <th data-field="TGL_Penerimaan" data-editable="true">TGL_Penerimaan</th>
                                                <th data-field="kadaluwarsa" data-editable="true">kadaluwarsa</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($obat as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_Obat.php?kode_obat=<?php echo $row['kode_obat'];?>&Nama=<?php echo $row['Nama'];?>&kegunaan=<?php echo $row['kegunaan'];?>&stok=<?php echo $row['stok'];?>
                                                            &TGL_Penerimaan=<?php echo $row['TGL_Penerimaan'];?>&kadaluwarsa=<?php echo $row['kadaluwarsa'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_Obat.php?kode_obat=<?php echo $row['kode_obat'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p> <b>"You Are The Best" <a href="https://smkmiftahulhikmah.sch.id">Puskesmas keren</a> <b> MEI MELINDA SARI.</p>
                        </div>
                    </div>
                </div>
            </div>
