...
<head>
    ...
    <title>Tambah Obat | SMK Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Tambah obat</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="all-form-element-inner">
                                                <form action="simpan_Obat.php" method="post">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Stok Obat</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="TGL_Penerimaan" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                     <div class="form-group-inner">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p> <b>"Experience is the best Teacher" ..//<b> <a href="https://smkmiftahulhikmah.sch.id">Puskesmas Indonesia..//</a> MEI MELINDA SARI.</p>
                        </div>
                    </div>
                </div>
            </div>
