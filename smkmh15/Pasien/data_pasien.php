...
<head>
    ...
    <title>Data Pasien | SMK Miftahul Hikmah</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="kode_pasien" data-editable="true">kode_pasien</th>
                                                ...
                                                <th data-field="penyakit" data-editable="true">penyakit</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($pasien as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['penyakit']."</td>"?>; 
                                                        <td>
                                                            <a href="edit_pasien.php?kode_pasien=<?php echo $row['kode_pasien'];?>&nama=<?php echo $row['nama'];?>&alamat=<?php echo $row['alamat'];?>&jenis_kelamin=<?php echo $row['jenis_kelamin'];?>
                                                            &penyakit=<?php echo $row['penyakit'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_pasien.php?kode_pasien=<?php echo $row['kode_pasien'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p> <b>"One Problem million solutions" <a href="https://smkmiftahulhikmah.sch.id">SMK Miftahul Hikmah</a> Mei Melinda Sari.</p>
                        </div>
                    </div>
                </div>
            </div>
