...
<head>
    ...
    <title>Data Barang | Syka Collection</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Data arang</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <?php
                                                ...
                                                foreach ($barang as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_barang.php?id_barang=<?php echo $row['id_barang'];?>&nama=<?php echo $row['nama'];?>&harga=<?php echo $row['harga'];?>&tgl_pembelian=<?php echo $row['tgl_pembelian'];?>&jumlah_stok=<?php echo $row['jumlah_stok'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_barang.php?id_barang=<?php echo $row['id_barang'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p> <a href="https://smkmiftahulhikmah.sch.id">SMK Miftahul Hikmah 2019 By Sikaa</a> </p>
                        </div>
                    </div>
                </div>
            </div>
