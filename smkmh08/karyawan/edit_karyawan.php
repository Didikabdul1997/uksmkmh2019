...
<head>
    ...
    <title>Edit Karyawan | Syka Collection</title>
                                            ...
                                            <div class="all-form-element-inner">
                                                <form action="simpan_edit_Karyawan.php" method="post">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Kelamin</label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" name="kelamin" value="<?php echo $kelamin; ?>" class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
