...
<head>
    ...
    <title>Data Karyawan | Syka Collection</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="nama" data-editable="true">Nama</th>x
												<th data-field="alamat" data-editable="true">Alamat</th>
                                                <th data-field="kelamin" data-editable="true">Kelamin</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($karyawan as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['kelamin']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_karyawan.php?id=<?php echo $row['id'];?>&nama=<?php echo $row['nama'];?>&alamat=<?php echo $row['alamat'];?>&kelamin=<?php echo $row['kelamin'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_karyawan.php?id=<?php echo $row['id'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
