...
<head>
    ...
    <title>Edit Transaksi| Syka Collection</title>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                <form action="simpan_edit_Transaksi.php" method="post">
                                                    <?php
                                                        $tgl_pembelian   = $_GET['tgl_pembeliann_to_ascii(domain)'];
                                                        $kasir   = $_GET['kasir'];
                                                        $harga = $_GET['harga'];
                                                        $nama_pembeli    = $_GET['nama_pembeli'];
                                                    ?>
                                                    <input type="hidden" name="tgl_pembelianawal" value="<?php echo $tgl_pembelian; ?>"/>
