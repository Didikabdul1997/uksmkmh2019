...
<head>
    ...
    <title>Data Transaksi | Syka Collection</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Transaksi</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data Transaksi</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_siswa.php">Tambah Transaksi</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="tgl_pembelian" data-editable="true">TGL_PEMBELIAN</th>
                                                <th data-field="kasir" data-editable="true">Kasir</th>x
												<th data-field="harga" data-editable="true">Karga</th>
                                                <th data-field="nama_pembeli" data-editable="true">Nama_pembeli</th>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                $rransaksi = mysqli_query($koneksi, "SELECT * from transaksi");
                                                $no=1;
                                                foreach ($transaksi as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_transaksi.php?tgl_pembeliann=<?php echo $row['tgl_pembelian'];?>&kasir=<?php echo $row['kasir'];?>&harga=<?php echo $row['harga'];?>&nama_pembeli=<?php echo $row['nama_pembeli'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_transaksi.php?id=<?php echo $row['id'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-copy-right">
                            <p>Copyright &copy; 2019 <a href="https://smkmiftahulhikmah.sch.id">Syka Collection</a> All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
