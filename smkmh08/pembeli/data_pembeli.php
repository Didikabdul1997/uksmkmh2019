...
<head>
    ...
    <title>Data Pembeli | Syka Collection</title>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="nama" data-editable="true">Nama_pembeli</th>x
                                            ...
                                            <?php
                                                ...
                                                foreach ($pembeli as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['total']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_pembeli.php?id=<?php echo $row['id'];?>&nama_pembeli=<?php echo $row['nama_pembeli'];?>&alamat=<?php echo $row['alamat'];?>&barang=<?php echo $row['barang'];?>&jumlah_barang=<?php echo $row['jumlah_barang'];?>&harga=<?php echo $row['harga'];?>&total=<?php echo $row['total'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_pembeli.php?id=<?php echo $row['id'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
