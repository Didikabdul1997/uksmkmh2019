...
<head>
    ...
    <title>Data jadwal | SMK Miftahul Hikmah</title>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> jadwal</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_jadwal" data-editable="true">id_jadwal</th>
                                                <th data-field="senin" data-editable="true">senin</th>
                                                <th data-field="selasa" data-editable="true">selasa</th>
												<th data-field="rabu" data-editable="true">rabu</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($jadwal as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['sabtu']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_jadwal.php?id_jadwal=<?php echo $row['id_jadwal'];?>&senin=<?php echo $row['senin'];?>&selasa=<?php echo $row['selasa'];?>&rabu=<?php echo $row['rabu'];?>&kamis=<?php echo $row['kamis'];?>&jumat=<?php echo $row['jumat'];?>&sabtu=<?php echo $row['sabtu'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_jadwal.php?id_jadwal=<?php echo $row['id_jadwal'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
