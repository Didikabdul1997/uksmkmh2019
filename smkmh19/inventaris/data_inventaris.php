...
<head>
    ...
    <title>Data inventaris | labolatorium komputer SMK Miftahul Hikmah</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">inventaris</a> <span class="bread-slash">/</span>
                                            </li>
                                            <li><span class="bread-blod">Data inventaris</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Tabel <span class="table-project-n">Data</span> inventaris</h1>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <div class="add-product">
                                        <a href="tambah_inventaris.php">Tambah inventaris</a>
                                    </div>
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="id_barang" data-editable="true">id_barang</th>
                                                <th data-field="nama_barang" data-editable="true">nama_barang</th>
                                                <th data-field="tanggal_masuk" data-editable="true">tanggal_masuk</th>
                                                <th data-field="jumlah" data-editable="true">jumlah</th>
                                            ...
                                            <?php
                                                ...
                                                foreach ($inventaris as $row){
                                                    echo "<tr>
                                                        ...
                                                        <td>".$row['jumlah']."</td>"; ?>
                                                        <td>
                                                            <a href="edit_inventaris.php?id_barang=<?php echo $row['id_barang'];?>&nama_barang=<?php echo $row['nama_barang'];?>&tanggal_masuk=<?php echo $row['tanggal_masuk'];?>&jumlah=<?php echo $row['jumlah'];?>"><button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                                            <a href="hapus_inventaris.php?id_barang=<?php echo $row['id_barang'];?>"><button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button></a>
                                                        </td><?php
                                                        echo"</tr>";
                                                    $no++;
                                                }
